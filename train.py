...
def main():
    ...
    #========= Loading Dataset =========#
    _, training_data = build_wmt_dataloader(src_txt_filepath=opt.train_src_txt_filepath, tgt_txt_filepath=opt.train_tgt_txt_filepaht, batch_size=opt.batch_size)
    _, validation_data = build_wmt_dataloader(src_txt_filepath=opt.train_src_txt_filepath, tgt_txt_filepath=opt.train_tgt_txt_filepaht, batch_size=opt.batch_size)
    opt.src_vocab_size = training_data.vocab_size['src']
    opt.trg_vocab_size = training_data.vocab_size['tgt']
    opt.src_pad_idx = training_data.special_token_index(Constants.PAD_WORD)
    opt.trg_pad_idx = training_data.special_token_index(Constants.PAD_WORD)
    print(opt)
